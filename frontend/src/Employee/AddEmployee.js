    ...
    return(
      <div className="app" >
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" id=" firstName" required placeholder="First Name" onChange={(e)=>{
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" id="lastName" required placeholder="Last Name" onChange={(e)=>{
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" id="phoneNumber" required placeholder="Phone Number" onChange={(e)=>{
        ...
        <div class="col-md-6">
          ...
          <div class="input-group has-validation">
            ...
            <input type="text" class="form-control" id="email" aria-describedby="inputGroupPrepend" required placeholder="Email" onChange={(e)=>{
